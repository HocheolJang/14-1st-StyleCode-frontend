...
class Card extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isDisplayNone: false,
      modalData: [],
      // API: `http://10.58.7.41:8000/ootd/${this.props.id}`,
    }
    // ${this.props.id}
  }
  // handleMouseOver = () => {
  ...
  //   handleClickLike = (e) => {
  //   fetch(this.API, {
  //     method: "GET",}).then((response) => {return response.json()}).then((result) => {
  ...
  //           this.setState({
  //             isLikeBtn: true,
  //             follower: this.props.follower + 1,
  //         })} else {
  //           this.setState({
  //             isLikeBtn: false,
  //           follower: this.props.follower - 1,
  //           })}
  // }
  API = `http://10.58.7.41:8000/ootd/1`;
              ...
              <div className="productInfoWrapper">
                <div className="productInfo">
                  ...
                  <p className="priceWrapper">
                    <span className="price">{parseInt(price-price*sale)}원</span>
                    <span className="originPrice">{parseInt(price)}원</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="authorWrapper">
            ...
            <div className="authorInfoWrapper">
              ...
              <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" clip-rule="evenodd"></path></svg>
                <span classNum="likeNum">{follower}</span>
